...
class Recomendacion():
    """
    Recomendacion : Contiene la informacion de: 
        Para recomendar un viaje se tidene en cuenta dos criteiros: Si el empleado ya existe, la recomendación sera
        la ciudad mas visitada por el usuario con promocion asignada. Por el contratio si si no tiene viajes 
        asignado va a secomendar la ciudad con mayor nymero de visitantes
    """
